...
public class AddShoesName extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent.getStringExtra("update") != null){
            setContentView(R.layout.activity_update_shoes_name);
...
//create a list of items for the spinner.
        ...
        String[] items = new String[]{"addidas", "nike","puma","skechers","vanz","converse"};
...
//set the spinners adapter to the previously created one.
    ...
    public void click(View view){
        ...
        if(view.getId() == R.id.confirm){
            ...
            Toast.makeText(getBaseContext(),"Add product cancel.",Toast.LENGTH_LONG).show();
        }
